...
public class QQUser implements Serializable {
    ...
    private static final long serialVersionUID = -8869939948658628770L;
    ...
    public QQUser(String nickname, ImageIcon face) {
        this.nickname = nickname;
        this.face = face;
    }

    public QQUser(String nickname) {
        this.nickname = nickname;
    }
